...
public class CallForgotFragment extends BaseFragment implements IFragment {
    private static final String FRAGMENT_NAME = "CallForgot";
    ...
    protected int getLayoutId() {
        return R.layout.fragment_callproof_forgot;
    }
    ...
    public static CallForgotFragment newInstance() {
        return new CallForgotFragment();
    }
}
